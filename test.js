...
test("One euro should be 156.5 yenes", function() {
    ...
    // Hago mi comparación (la prueba)
    expect(fromDollarToYen(3.5)).toBe(547.75); // Si 1 euro son 156.5 yenes, entonces 3.5 euros debe ser (3.5 * 156.5)
})
...
test("One euro should be 0.87 pounds", function() {
    ...
    // Hago mi comparación (la prueba)
    expect(fromYenToPound(3.5)).toBe(3.045); // Si 1 euro son 0.87 pounds, entonces 3.5 euros debe ser (3.5 * 0.87)
})